...
import "./interfaces/IUniswapV2PairFull.sol";
import "./interfaces/IERC20.sol";
import "./interfaces/IWETH.sol";

contract PushLaunchpadV2Router2 is IUniswapV2Router02 {
    ...
    function removeLiquidityWithPermit(
        ...
        IUniswapV2PairFull(pair).permit(
            msg.sender,
            address(this),
            value,
            deadline,
    ...
    function _swap(
        ...
        for (uint i; i < path.length - 1; i++) {
            ...
            address to = i < path.length - 2
                ...
                : _to;
            IUniswapV2PairFull(UniswapV2Library.pairFor(factory, input, output))
    ...
    function _swapSupportingFeeOnTransferTokens(
        ...
        for (uint i; i < path.length - 1; i++) {
            (address input, address output) = (path[i], path[i + 1]);
            (address token0, ) = UniswapV2Library.sortTokens(input, output);
            IUniswapV2PairFull pair = IUniswapV2PairFull(
